                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($data->status_transaksi == 'sudah') {
                                                                echo '<a data-toggle="modal" style="width:100%" data-target="#modalEdit" onclick="edit_pemeriksaan('.$data->id_pemeriksaan.')" class="btn btn-xs btn-info"><i class="fa fa-book"></i></a>';    
                                                            } else {
